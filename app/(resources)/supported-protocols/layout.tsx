/************************************************************************************************
 ** Supported Protocols Layout Component & Metadata:
 **
 ** This file defines the layout component and metadata generation function for the
 ** "Supported Protocols" section of the application. The layout is a simple pass-through for
 ** its children, while `generateMetadata` provides default SEO and social sharing information
 ** for all pages under `/supported-protocols`.
 ************************************************************************************************/
 ...
 **
 ** Asynchronously generates default metadata for all pages within the "Supported Protocols"
 ** section. This metadata includes a general title, description, keywords, and Open Graph/
 ** Twitter card information, promoting the discoverability of ShapeShift's supported protocols.
 **
 ** Returns:
 ** - A Promise resolving to a `Metadata` object containing default SEO and social sharing
 **   information for the supported protocols section.
 ************************************************************************************************/
 ...
 **
 ** Defines the main layout structure for pages within the "Supported Protocols" section. This
 ** component is a simple pass-through, rendering its `children` directly. It serves as the
 ** root layout for routes like `/supported-protocols` and `/supported-protocols/[slug]`.
 **
 ** Args:
